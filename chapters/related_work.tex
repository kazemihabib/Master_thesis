...
\guide{Explain that unlike previous work using fine-tuning or dedicated
detectors, your work evaluates off-the-shelf MLLMs purely through prompting --
no weight updates. Position your study as an empirical evaluation of what MLLMs
can and cannot do as zero-shot/few-shot detectors. (The actual evaluation
methodology is in \Cref{chap:methodology}; keep this section about related literature).}
